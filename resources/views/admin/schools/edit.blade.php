<x-layout>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-5 pb-2 mb-3 border-bottom text-body-secondary">
        ...
        <i class="bi-caret-right-fill fs-1"></i> Form Ubah Sekolah</h1>
        </div>
        ...
        <div class="mt-2 p-3 text-body-secondary">
            <form action="/schools/{{$school->id}}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="npsn" class="form-control @error('npsn') is-invalid @enderror" name="npsn" id="npsn" placeholder="Cth. 12345678 (8 digit angka)" value="{{old('npsn',$school->npsn)}}" required>
                    @error('npsn')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Cth. SMK NEGERI 01 SEMARANG" value="{{old('name',$school->name)}}" required>
                    @error('name')
                        <div class="invalid-feedback">
                            {{$message}}
                        </div>
